...
@Service("schedule001Service")
public class Schedule001ServiceImpl implements Schedule001Service{
	@Resource(name = "propertiesService")
	protected EgovPropertyService propertiesService;

	@Override
	public List<Map<String, Object>> selectSchdule001List(Map<String, Object> map) throws Exception {
		...
		System.out.println("11:"+travelUrl+addUrl.toString());
	...
	public List<Map<String, Object>> selectSchdule001ListAjaxEx1(Map<String, Object> map) {
		...
		return apiCommon.getJsonParsing(travelUrl+addUrl.toString());
	}
	...
	public String selectSchdule001ListAjax(String param) throws Exception{
		...
		return apiCommon.selectSchdule(param, travelUrl, authenticationKey);
	}
}
