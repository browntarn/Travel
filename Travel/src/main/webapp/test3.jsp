...
function searchType1(){
 	$.ajax({
		type: "POST",
		url : "<c:url value='/searchPost1.do' />",
		dataType: "json",
		contentType:"application/json;charset=UTF-8",
		async: true,
		success : function(data, status, xhr) {
...
function searchType2(){
    ...
    console.log(sendData);
 	$.ajax({
		type: "POST",
		url : "<c:url value='/searchPost2.do' />",
		data: sendData,
		dataType: "json",
		contentType:"application/json;charset=UTF-8",
		async: false,
...
function searchType3(){
    ...
    console.log(sendData);
 	$.ajax({
		type: "POST",
		url : "<c:url value='/searchPost3.do' />",
		data: sendData,
		dataType: "json",
		contentType:"application/json;charset=UTF-8",
		async: false,
...
<div style="margin-bottom:10px;">
	...
	<button onclick="searchType1();">조회1</button>
	<button onclick="searchType2();">조회2</button>
	<button onclick="searchType3();">조회3</button>
</div>
